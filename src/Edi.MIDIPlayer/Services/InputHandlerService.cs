...
public class InputHandlerService(IDisplayService displayService) : IInputHandler
{
    public string GetMidiFileUrl(string[] args)
    {
        ...
        displayService.WriteMessage("INPUT", "Enter MIDI file path or URL:", ConsoleColor.Yellow);
